...
<body>
    ...
    <div class="w-full h-screen flex flex-col relative">
        @php
        // Pastikan variabel $tvData tidak kosong dan memiliki properti backdrop_path
        $backdropPath = $tvData && isset($tvData->backdrop_path) ? $imageBaseUrl . 'original' . $tvData->backdrop_path : "";
        @endphp
