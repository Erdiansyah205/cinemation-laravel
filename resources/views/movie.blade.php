...
<body>
    <div class="w-full h-auto min-h-screen flex flex-col ">
        ...
        <!-- Sort Section -->
        <div class="ml-28 mt-8 flex flex-row">
        ...
        <!-- Data Loader -->
        <div class="w-full pl-28 flex justify-center mb-5" id="autoLoad">
        ...
        <!-- Eror Notification -->
        <div id="notification" class="min-w-[250px] p-4 bg-red-700 text-white text-center rounded-lg fixed z-10 right-0 mr-10 mt-5 drop-shadow-lg">
            <span id="notificationMessage"></span>
        </div>

        <!-- Load More -->
        <div class="w-full pl-20 pr-10" id="loadMore">
            <button class="w-full mb-10 bg-develobe-500 text-white p-4 font-inter font-bold rounded-xl uppercase drop-shadw-lg" onclick="loadMore()">Load More</button>
        </div>
    ...
    <script>
        ...
        let minimalVolter = "<?php echo $minimalVolter; ?>";
        ...
        function loadMore() {
            $.ajax({
                    url: `${baseUrl}/discover/movie?page=${++page}&sort_by=${sortBy}&api_key=${apiKey}&vote_count.gte=${minimalVolter}`,
                    type: "get",
                    beforeSend: function() {
                        // Show Loader
                        $("#autoLoad").show();
                ...
                .fail(function(jqXHR, ajaxOptions, thrownError) {
                    ...
                    // Show Notification
                    $("#notificationMessage").text("Terjadi kendala. coba beberpa saat lagi");
                    $("#notification").show();
